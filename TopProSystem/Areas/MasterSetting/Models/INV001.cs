...
namespace TopProSystem.Areas.MasterSetting.Models
{
    ...
    public partial class INV001
    {
        ...
        public Nullable<decimal> CAPUFAT { get; set; }
        public Nullable<double> CAHCGAT { get; set; }
        public Nullable<decimal> CATRFAT { get; set; }
        public Nullable<decimal> CACSTHC { get; set; }
        ...
        public string CAPRDDIA { get; set; }
        public string CASTLGR { get; set; }
        ...
        public string CADLVCD { get; set; }
        public string CARGSTM { get; set; }
        public Nullable<double> CAPTXATD { get; set; }
        public string CARMTP { get; set; }
    }
}

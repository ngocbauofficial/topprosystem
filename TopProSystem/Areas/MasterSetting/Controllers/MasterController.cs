...
namespace TopProSystem.Areas.MasterSetting.Controllers
{
    ...
    public class MasterController : BaseMasterController
    {
        ...
        public ActionResult GetUpdateLocationMaster(string locationcode)
        {
            ...
            DAL.MA004.MA004_DAL mA004_DAL = new DAL.MA004.MA004_DAL();
            return View(mA004_DAL.GetMA004(locationcode));
        }
        ...
        public ActionResult GetInsertLocationMaster()
        {
        ...
        public ActionResult CheckCurrencyCodeInUsed(string currencyCode)
        {
            DAL.MA009.MA009_DAL _ma009dal = new DAL.MA009.MA009_DAL();
            return Json(_ma009dal.CheckCurrencyCodeInUsed(currencyCode), JsonRequestBehavior.AllowGet);
        }
        ...
        public ActionResult DeleteExchangeRate(string _array)
        {
            ...
            if (array != null)
            {
                foreach (var currencyCode in array)
                {
                    if (!_ma009dal.Delete(currencyCode))
        ...
        public ActionResult GetUpdateExchangeRate(string curCode)
        {
        ...
        //public JsonResult GetExchangeRate(string curcode)
        //{
        //    DAL.MA009.MA009_DAL _ma009dal = new DAL.MA009.MA009_DAL();
        //    return Json(_ma009dal.GetExchangeRate(curcode), JsonRequestBehavior.AllowGet);
        //}
        ...
        public JsonResult CheckExchangeRateInUsedReference(string code)
        {

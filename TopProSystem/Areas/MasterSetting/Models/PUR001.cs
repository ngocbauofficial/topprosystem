...
namespace TopProSystem.Areas.MasterSetting.Models
{
    ...
    public partial class PUR001
    {
        ...
        public Nullable<decimal> ABWT { get; set; }
        ...
        public Nullable<decimal> ABPRUP { get; set; }
        public Nullable<decimal> ABPRUPD { get; set; }
        public Nullable<decimal> ABPRAT { get; set; }
        public Nullable<decimal> ABPRATD { get; set; }
        public Nullable<decimal> ABPTXAT { get; set; }
        public Nullable<decimal> ABPTXAD { get; set; }
        ...
        public Nullable<decimal> WarehousingWeight { get; set; }
        public string ABPIVNO { get; set; }
        public Nullable<System.DateTime> ABPIVDT { get; set; }
